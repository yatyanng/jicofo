 ...
 * @author Pawel Domas
 */
public interface ChatRoom2 extends ChatRoom {
	/**
	 ...
	 *
	 * @param mucJid full MUC jid of the user for whom we want to find chat member
	 *               instance. Ex. chatroom1@muc.server.com/nick1234
	 *
