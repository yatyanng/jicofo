...
public class SourceGroup {
	 ...
	 * 
	 * @param content the <tt>ContentPacketExtension</tt> that contains(or not) the
	 *                description of source groups.
	...
	public static List<SourceGroup> getSourceGroupsForContent(ContentPacketExtension content) {
		...
		List<SourceGroupPacketExtension> groupExtensions = rtpDescPe
				.getChildExtensionsOfType(SourceGroupPacketExtension.class);
	 ...
	 * @param sources   a {@link List} of the group's {@link SourcePacketExtension}s
	 */
	 ...
	 *
	 * @param source the <tt>SourcePacketExtension</tt> to be added to this group.
	 */
	 ...
	 *
	 * @param video the list of <tt>SourcePacketExtension</tt> which will be added
	 *              to this group.
	 */
	 ...
	 *
	 * NOTE it makes sense only once the attributes have been copied from the media
	 * section {@link SourcePacketExtension}s, as normally
	 * {@link SourcePacketExtension}s signalled inside of
	 * {@link SourceGroupPacketExtension} do not contain any parameters including
	 * MSID. See {@link SSRCValidator#copySourceParamsToGroups()}.
	 *
	...
	public String getGroupMsid() {
		...
		return sources.size() > 0 ? SSRCSignaling.getMsid(sources.get(0)) : null;
	}
	...
	/**
	 * Returns the underlying <tt>SourceGroupPacketExtension</tt> wrapped by this
	 * <tt>SourceGroup</tt> instance.
	 */
	 ...
	 * considered equal if: 1. They have the same semantics 2. They have the same
	 * sources (according to {@link SourcePacketExtension#equals(Object)}), and in
	 * the same order.
	 *
	...
	public boolean equals(Object obj) {
		...
		if (StringUtils.isNullOrEmpty(semantics) && !StringUtils.isNullOrEmpty(getSemantics())) {
			return false;
		}
	 ...
	 *
	 * @return <tt>true</tt> if this <tt>SourceGroup</tt> is empty or <tt>false</tt>
	 *         otherwise.
	 */
	...
	public String toString() {
		...
		return "SourceGroup[" + this.group.getSemantics() + ", " + sources + "]@" + Integer.toHexString(hashCode());
	}
