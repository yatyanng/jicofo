...
public class BridgeEvent extends Event {
	...
	/**
	 * The event is fired by {@link JvbDoctor} when the JVB health check fails. It
	 * should be followed by {@link #BRIDGE_DOWN} event generated by
	 * {@link BridgeSelector}.
	 */
	public static final String HEALTH_CHECK_FAILED = "org/jitsi/jicofo/JVB/UNHEALTHY";

	/**
	 * The event is emitted by
	 * {@link org.jitsi.impl.protocol.xmpp.colibri.ColibriConferenceImpl} when new
	 * video channels are being allocated/expired which results in video stream
	 * count change. It is consumed by {@link BridgeSelector} to estimate the
	 * current video stream count for each JVB.
	 */
	public static final String VIDEOSTREAMS_CHANGED = "org/jitsi/jicofo/JVB/VIDEOSTREAMS_CHANGE";
	 ...
	 * 
	 * @param bridgeJid the JID of the bridge for which the event will be created.
	 * @return {@link #BRIDGE_UP} <tt>BridgeEvent</tt> for given <tt>bridgeJid</tt>.
	 */
	 ...
	 *         <tt>bridgeJid</tt>.
	 */
	static public BridgeEvent createVideoStreamsChanged(Jid bridgeJid, int videoStreamCount) {
	 ...
	 * <tt>BridgeEvent</tt>.
	 * 
	 * @return <tt>Integer</tt> or <tt>null</tt> if attribute not present for given
	 *         event.
	 */
	...
	public boolean equals(Object obj) {
		...
		boolean sameTopicAndJid = getTopic().equals(other.getTopic()) && getBridgeJid().equals(other.getBridgeJid());
		if (!sameTopicAndJid) {
			return false;
		}
