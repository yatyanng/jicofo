...
public class Main {
	 ...
	 * for the XMPP client connection.
	 */
	private static final String DOMAIN_ARG_NAME = "domain";

	/**
	 * The name of the command-line argument which specifies the name of XMPP domain
	 * used by focus user to login.
	 */
	private static final String USER_DOMAIN_ARG_NAME = "--user_domain";

	/**
	 * The name of the command-line argument which specifies the name of XMPP user
	 * name to be used by the focus user('focus' by default).
	 */
	...
	/**
	 * The name of the command-line argument which specifies the password used by
	 * focus XMPP user to login. If not provided then focus will use anonymous
	...
	public static void main(String[] args) throws ParseException {
		...
		// Host name
		host = cmdLine.getOptionValue(HOST_ARG_NAME, componentDomain == null ? HOST_ARG_VALUE : componentDomain);
		...
		FocusComponent component = new FocusComponent(host, port, componentDomain, componentSubDomain, secret,
				focusAnonymous, focusUserName + "@" + focusDomain);
