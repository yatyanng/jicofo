 ...
 * @author Pawel Domas
 */
public class JicofoBundleConfig extends OSGiBundleConfig {
	/**
	...
	/**
	 * Indicates whether mock protocol providers should be used instead of original
	 * Jitsi protocol providers.
	 */
	 ...
	 * implementation.
	 *
	 * @param useMockProtocols <tt>true</tt> if Jitsi protocol providers should be
	 ...
	 * <tt>BundleActivator</tt> implementations) comprising Jitsi Meet Focus. An
	 * element of the <tt>BUNDLES</tt> array is an array of <tt>String</tt>s and
	 * represents an OSGi start level.
	 */
	@Override
	protected String[][] getBundlesImpl() {
		...
		String[][] bundles = { { "org/jitsi/service/libjitsi/LibJitsiActivator" },
				{ "net/java/sip/communicator/util/UtilActivator", "org/jitsi/eventadmin/Activator",
				...
				{ "org/jitsi/jicofo/FocusBundleActivator", "org/jitsi/impl/reservation/rest/Activator",
						"org/jitsi/jicofo/auth/AuthBundleActivator" },
				{ "org/jitsi/jicofo/JvbDoctor", "org/jitsi/jicofo/VersionBroadcaster" } };
