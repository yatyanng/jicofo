...
public class JitsiMeetConfig {
	 ...
	 * The logger.
	 */
	private final static Logger logger = Logger.getLogger(JitsiMeetConfig.class);

	/**
	 * The name of the property which specifies the packet delay for the audio
	 * channels used in the conference.
	 *
	 * *NOTE* It is meant to be used for automated testing of the
	 * {@link LipSyncHack} only !
	 */
	...
	/**
	 * The name of the property which enables the inclusion of the REMB RTCP in the
	 * offer.
	 */
	public static final String PNAME_ENABLE_REMB = "enableRemb";

	/**
	 * The name of the property which enables the inclusion of the TCC RTP header
	 ...
	 * used instead of any bridges elected by <tt>BridgeSelector</tt>. The property
	 * is meant to be used in a test that aims to run a conference on specific
	 * bridge instance. That property is per conference specific.
	 */
	...
	/**
	 * The name of the property that determines the min partcipants to start the
	 * call.
	 */
	public static final String PNAME_MIN_PARTICIPANTS = "minParticipants";

	/*
	 * The name of the open sctp configuration property. Pass 'true' to enable or
	 * 'false' to disable.
	 */
	public static final String PNAME_OPEN_SCTP = "openSctp";

	/**
	 * The name of the configuration property used to configure Jigasi(SIP gateway)
	 * instance.
	 */
	 ...
	 */
	public static final String PNAME_USE_ROOM_AS_SHARED_DOC_NAME = "useRoomAsSharedDocumentName";
	 ...
	 * 
	 * @param properties a string to string map that contains name to value mapping
	 ...
	 * <tt>BridgeSelector</tt>. <tt>null</tt> if not specified. That property is per
	 * conference specific.
	 */
	...
	/**
	 * Returns pre-configured XMPP address of SIP gateway or <tt>null</tt> if no
	 * info was passed in the config.
	 */
	/*
	 * public String getPreConfiguredSipGateway() { return
	 * properties.get(SIP_GATEWAY_PNAME); }
	 */

	/**
	 * Returns an integer value of channel last N property or <tt>null</tt> if it
	...
	/**
	 * Return a <tt>Boolean</tt> value of the {@link #ENABLE_LIPSYNC} property (can
	 * be <tt>null</tt>).
	 */
	...
	/**
	 * Returns an <tt>Integer</tt> value of the {@link #AUDIO_PACKET_DELAY} config
	 * property(can be <tt>null</tt>).
	 */
	...
	public boolean isRtxEnabled() {
		...
		return StringUtils.isNullOrEmpty(disableRtxStr) || !Boolean.parseBoolean(disableRtxStr);
	}

	/**
	 * Gets a boolean that indicates whether or not to enable the REMB RTP header
	...
	/**
	 * Gets the minimum number of participants that need to be present in the call
	 * before we start it.
	 */
	public int getMinParticipants() {
		Integer minParticipants = getInt(PNAME_MIN_PARTICIPANTS);
		return minParticipants != null ? minParticipants : DEFAULT_MIN_PARTICIPANTS;
	}

	/**
	 * Returns the value of the open sctp configuration property or <tt>null</tt> if
	...
	/**
	 * Return a <tt>boolean</tt> value of the {@link #USE_ROOM_AS_SHARED_DOC_NAME}
	 * property. Indicates if the room name should be used as a shared document
	 * name.
	 */
