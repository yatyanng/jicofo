 ...
 * @author Boris Grozev
 */
public class OctoParticipant extends AbstractParticipant {
	/**
	 * A flag which determines when the session can be considered established. This
	 * is initially set to false, and raised when the colibri channels are allocated
	 * (at which point we know they IDs and we can send updates via colibri).
	 */
	private boolean sessionEstablished = false;

	/**
	 * The list of remote Octo relay IDs for this {@link OctoParticipant}, i.e. the
	 * relays which will be set for the Octo channels.
	 *
	 ...
	 * 
	 * @param conference the {@link JitsiMeetConference} which this participant will
	 *                   be a part of.
	...
	/**
	 * Updates the sources and source groups of this participant with the sources
	 * and source groups scheduled to be added or removed via
	 ...
	 *
	 * @return {@code true} if the call resulted in this participant's sources or
	 *         source groups to change, and {@code false} otherwise.
	 */
