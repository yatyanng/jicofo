...
public class LoginUrlIq extends IQ {
	...
	/**
	 * The name of the attribute that carries the name of conference room which will
	 * be used as authentication context.
	 */
	public static final String ROOM_NAME_ATTR_NAME = "room";

	/**
	 * The name of the attribute that indicates if carried URL is a popup one. In
	 * other words if carried URL is intended to be opened in popup window.
	 */
	public static final String POPUP_ATTR_NAME = "popup";

	/**
	 * The name of the property that holds machine unique identifier. It is used to
	 * distinguish sessions for the same user on different machines.
	 */
	...
	/**
	 * Machine unique identifier used to distinguish sessions for the same user on
	 * different machines.
	 */
