...
public class ConferenceIq extends IQ {
	...
	/**
	 * The name of the attribute that stores the name of multi user chat room that
	 * is hosting Jitsi Meet conference.
	 */
	public static final String ROOM_ATTR_NAME = "room";

	/**
	 * The name of the attribute that indicates if the focus has already joined the
	 * room(otherwise users might decide not to join yet).
	 */
	public static final String READY_ATTR_NAME = "ready";

	/**
	 * The name of the attribute that tells to the user what is the jid of the focus
	 * user.
	 */
	...
	/**
	 * Indicates if the focus is already in the MUC room and conference is ready to
	 * be joined.
	 */
	...
	protected IQChildElementXmlStringBuilder getIQChildElementBuilder(IQChildElementXmlStringBuilder xml) {
		xml.optAttribute(ROOM_ATTR_NAME, room).optAttribute(FOCUS_JID_ATTR_NAME, focusJid)
				.optAttribute(SESSION_ID_ATTR_NAME, sessionId).optAttribute(MACHINE_UID_ATTR_NAME, machineUID)
	 ...
	 * which corresponds to the ID of client authentication session. <tt>null</tt>
	 * if not specified.
	 */
	...
	public static class Property extends AbstractPacketExtension {
		...
		/**
		 * Creates new <tt>Property</tt> instance initialized with given <tt>name</tt>
		 * and <tt>value</tt> values.
		 *
