 ...
 * @author Pawel Domas
 */
public class XmppProviderFactory extends ProtocolProviderFactory {
	/**
	 ...
	 */
	protected XmppProviderFactory(BundleContext bundleContext, String protocolName) {
	 ...
	 */
	@Override
	public AccountID installAccount(String s, Map<String, String> stringStringMap)
	 ...
	 */
	@Override
	public void modifyAccount(ProtocolProviderService protocolProviderService, Map<String, String> stringStringMap)
