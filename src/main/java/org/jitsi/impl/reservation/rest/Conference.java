...
public class Conference {
	...
	/**
	 * FIXME: not used Conference room URL.
	 */
	private String url;

	/**
	 * FIXME: not used Conference room pin password.
	 */
	private String pin;

	/**
	 * FIXME: not used Sip gateway instance identifier.
	 */
	 ...
	 *                    room_name@muc.server.net. Short room name is extracted and
	 *                    stored in {@link #name} field.
	...
	/**
	 * Returns full XMPP MUC room address that hosts the conference, in the form of
	 ...
	 * 
	 * @param sipId SIP gateway instance identifier assigned by the reservation
	 ...
	 * 
	 * @param startTime a <tt>Date</tt> which will be set as conference start time.
	 */
	...
	/**
	 * Creates map of conference properties which describe this <tt>Conference</tt>
	 * instance.
	 *
	...
	/**
	 * Converts given time in millis into string representation in format HH:MM.
	 * Value will be stored only if it's greater or equal to zero.
	 *
	...
	/**
	 * Formats given <tt>Date</tt> using {@link ConferenceJsonHandler #DATE_FORMAT}
	 * and stores it in output JSON object map fi given value is not null.
	 *
	 ...
	 * @param value <tt>Object</tt> value which will be stored in output JSON map.
	 */
	...
	/**
	 * Stores given <tt>String</tt> in output JSON object map if it's value is not
