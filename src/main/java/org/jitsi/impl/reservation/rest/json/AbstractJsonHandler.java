 ...
 * @author Pawel Domas
 */
public abstract class AbstractJsonHandler<T> implements ContentHandler {
	/**
	...
	/**
	 * Variable stores currently edited instance. It can be set with
	 * {@link #setForUpdate(Object)}.
	 */
	 ...
	 * instance will have it's fields edited during the process and no new instance
	 * will be created.
	 *
	 * @param instanceToUpdate the instance which fields should be updated during
	 *                         parsing.
	 */
	...
	/**
	 * Utility method for checking if given <tt>primitive</tt> is a <tt>String</tt>.
	 *
	...
	/**
	 * Utility method for checking if given <tt>primitive</tt> is a <tt>Number</tt>.
	 *
	 * @param primitive the object to check
	 *
	 * @throws ParseException if given <tt>primitive</tt> is not instance of
	...
	/**
	 * Methods is used to verify if given <tt>oldValue</tt> has not been modified
	 * during parsing. It can be used to enforce read-only policy on some fields.
	 * Exception will be thrown only if <tt>oldValue</tt> is not <tt>null</tt> nor
	 * empty which means that it has been set on edited instance.
	 *
	 * @param oldValue old value of the field to be checked. If <tt>null</tt> no
	 *                 exception will be thrown which means that value has not been
	 *                 assigned yet.
	 ...
	 *                        <tt>newValue</tt> is not equal to the same as the old
	 *                        one.
	 */
