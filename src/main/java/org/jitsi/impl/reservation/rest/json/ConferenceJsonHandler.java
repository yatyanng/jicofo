...
import org.jitsi.impl.reservation.rest.Conference;
 ...
 * @author Pawel Domas
 */
public class ConferenceJsonHandler extends AbstractJsonHandler<Conference> {
	/**
	 * The logger.
	 */
	private final static Logger logger = Logger.getLogger(ConferenceJsonHandler.class);
	 ...
	 */
	public static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSX");
