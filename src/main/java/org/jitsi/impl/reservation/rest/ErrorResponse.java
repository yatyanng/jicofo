...
public class ErrorResponse {
	...
	/**
	 * In case of Conference POST conflict can occur. Reservation system will return
	 * conflicting conference ID in response(which is stored in this field).
	 */
	 ...
	 * 
	 * @param error error <tt>String</tt> returned in reservation system response.
	 */
	 ...
	 * 
	 * @param message error message string returned by the reservation system to be
	...
	/**
	 * Sets conflicting conference ID returned in 409 response to Conference POST
	 * request.
	 *
	 * @param conflictId conflicting conference identifier to set on this instance.
	 */
	...
	public String toString() {
		return "ErrorResponse[e: " + error + ", m: " + message + ", conflict: " + conflictId + "]@" + hashCode();
	}
}
