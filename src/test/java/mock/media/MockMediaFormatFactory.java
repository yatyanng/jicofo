 ...
 *
 */
public class MockMediaFormatFactory implements MediaFormatFactory {
	@Override
	...
	@Override
	public MediaFormat createMediaFormat(String encoding, double clockRate, Map<String, String> formatParams,
			Map<String, String> advancedAttrs) {
		return null;
	}

	@Override
	public MediaFormat createMediaFormat(String encoding, double clockRate, int channels, float frameRate,
			Map<String, String> formatParams, Map<String, String> advancedAttrs) {
		return null;
	}

	@Override
	public MediaFormat createMediaFormat(byte rtpPayloadType, String encoding, double clockRate, int channels,
