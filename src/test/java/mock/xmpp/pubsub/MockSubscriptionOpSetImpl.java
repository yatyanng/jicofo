 ...
 * @author Pawel Domas
 */
public class MockSubscriptionOpSetImpl implements OperationSetSubscription {
	...
	private Map<String, List<PayloadItem>> nodeItems = new HashMap<String, List<PayloadItem>>();
	...
	public void fireSubscriptionNotification(String node, String itemId, ExtensionElement payload) {
