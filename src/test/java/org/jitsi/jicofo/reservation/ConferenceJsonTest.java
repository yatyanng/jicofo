...
public class ConferenceJsonTest {
	@Test
	public void testParseConference() throws Exception {
		// ConferenceIq
	...
	@Test
	public void testToJson() throws XmppStringprepException {
		...
		Conference conf = new Conference(JidCreate.entityBareFrom("test1@example.com"), "pawel.gawel", c.getTime());
