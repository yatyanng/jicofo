...
public class MediaSourceMapTest {
	...
	public void testSSRCRemove() {
		...
		SourcePacketExtension audioSSRC1 = SourceUtil.createSourceWithSsrc(12312435L,
				new String[][] { { "cname", "valsda42342!!@#duAppppa" }, { "msid", "sd-saf-2-3-rf2-r43" } });
		SourcePacketExtension audioSSRC2 = SourceUtil.createSourceWithSsrc(5463455L,
				new String[][] { { "cname", "valsda42342!!@#duAppppa" }, { "msid", "sd-saf-2-3-rf2-r43" } });

		SourcePacketExtension videoSSRC1 = SourceUtil.createSourceWithSsrc(954968935L,
				new String[][] { { "cname", "valsdsdf@$@#a42342!!@#duAppppa" }, { "msid", "bfghjh56-udff2-r43" } });
		SourcePacketExtension videoSSRC2 = SourceUtil.createSourceWithSsrc(6456345L,
				new String[][] { { "cname", "valsdsdf@$@#a42342!!@#duAppppa" }, { "msid", "bfghjh56-udff2-r43" } });
		SourcePacketExtension videoSSRC3 = SourceUtil.createSourceWithSsrc(3645473245L,
				new String[][] { { "cname", "valsdsdf@$@#a42342!!@#duAppppa" }, { "msid", "bfghjh56-udff2-r43" } });
		...
		compareSSRCs(toBeRemoved.getSourcesForMedia("audio"), removed.getSourcesForMedia("audio"));

		compareSSRCs(toBeRemoved.getSourcesForMedia("video"), removed.getSourcesForMedia("video"));
	}

	private void compareSSRCs(List<SourcePacketExtension> ssrcList1, List<SourcePacketExtension> ssrcList2) {
	...
	private void compareSSRC(SourcePacketExtension ssrc1, SourcePacketExtension ssrc2) {
	...
	private void compareParam(ParameterPacketExtension pe1, ParameterPacketExtension pe2) {
