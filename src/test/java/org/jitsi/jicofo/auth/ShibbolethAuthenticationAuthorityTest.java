...
public class ShibbolethAuthenticationAuthorityTest {
	...
	public static void setUpClass() throws Exception {
		...
		System.setProperty(AuthBundleActivator.LOGIN_URL_PNAME, "shibboleth:default");
		System.setProperty(AuthBundleActivator.LOGOUT_URL_PNAME, "shibboleth:default");
		osgi.init();
	}
	...
	@Test
	public void testShibbolethAuthenticationModule() throws Exception {
		FocusComponent focusComponent = MockMainMethodActivator.getFocusComponent();

		ShibbolethAuthAuthority shibbolethAuth = (ShibbolethAuthAuthority) ServiceUtils
				.getService(FocusBundleActivator.bundleContext, AuthenticationAuthority.class);
		...
		assertNotNull(authError);
		assertNotNull(authError.getError().getExtension(SessionInvalidPacketExtension.ELEMENT_NAME,
