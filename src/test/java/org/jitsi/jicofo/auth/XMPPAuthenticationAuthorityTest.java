...
public class XMPPAuthenticationAuthorityTest {
	...
	public static void setUpClass() throws Exception {
		...
		System.setProperty(AuthBundleActivator.LOGIN_URL_PNAME, "XMPP:" + authDomain);
		osgi.init();
	}
	...
	@Test
	public void testXmppDomainAuthentication() throws Exception {
		FocusComponent focusComponent = MockMainMethodActivator.getFocusComponent();

		XMPPDomainAuthAuthority xmppAuth = (XMPPDomainAuthAuthority) ServiceUtils
