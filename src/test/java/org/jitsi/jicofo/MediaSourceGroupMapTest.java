...
public class MediaSourceGroupMapTest {
	...
	public void testContainsGroup() {
		/**
		 * Make sure that groups with the same semantic but different source types (RID
		 * vs SSRC) don't collide
		 */
		MediaSourceGroupMap sourceGroups = new MediaSourceGroupMap();
		// First add an ssrc SIM group
		SourceGroup ssrcSimGroup = SourceUtil.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
				new SourcePacketExtension[] { SourceUtil.createSourceWithSsrc(123123L, new String[][] {}),
		...
		SourceGroup ridSimGroup = SourceUtil.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
				new SourcePacketExtension[] { SourceUtil.createSourceWithRid("1", new String[][] {}),
	...
	public void testRemoveSSRCGroup() {
		...
		SourceGroup audioGroup1 = SourceUtil
				.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_FID,
						new SourcePacketExtension[] {
								SourceUtil.createSourceWithSsrc(
										345646L,
										new String[][] { { "cname", "bfdlkbmfdl" },
												{ "msid", "3425345-fgdh-54y45-hghfgh" } }),
								SourceUtil.createSourceWithSsrc(786587L, new String[][] { { "cname", "vxpoivoiul" },
										{ "msid", "985-54y-55mgfg7-4-yh54" } }) });
		SourceGroup audioGroup2 = SourceUtil
				.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
						new SourcePacketExtension[] {
								SourceUtil.createSourceWithSsrc(
										2265675L,
										new String[][] { { "cname", "89fd7g87dfbu" },
												{ "msid", "546-54-234-435-435" } }),
								SourceUtil.createSourceWithSsrc(
										3455667L,
										new String[][] { { "cname", "hgj09j8gh0j8" },
												{ "msid", "657657-435-34534-5467" } }),
								SourceUtil.createSourceWithSsrc(8979879L, new String[][] { { "cname", "7nb89m79bnm" },
										{ "msid", "4562-724575-54754-4527" } }) });
		SourceGroup audioGroup3 = SourceUtil
				.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
						new SourcePacketExtension[] {
								SourceUtil.createSourceWithSsrc(456457L,
										new String[][] { { "cname", "vdfvdf8789df" },
												{ "msid", "56765-756756-34534" } }),
								SourceUtil.createSourceWithSsrc(
										234325L,
										new String[][] { { "cname", "786dsf8g8dfg6" },
												{ "msid", "678678-56756-56756-65765" } }),
								SourceUtil.createSourceWithSsrc(879879L, new String[][] { { "cname", "oilioli9io9" },
		...
		SourceGroup videoGroup1 = SourceUtil
				.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
						new SourcePacketExtension[] {
								SourceUtil.createSourceWithSsrc(
										2345346L,
										new String[][] { { "cname", "342kj5hk3h5" },
												{ "msid", "476457-4355-456546-456" } }),
								SourceUtil.createSourceWithSsrc(
										768678L,
										new String[][] { { "cname", "546lkjn45lk" },
												{ "msid", "245634-24536-2456-4526" } }),
								SourceUtil.createSourceWithSsrc(
										5646L,
										new String[][] { { "cname", "32lk4j3l232" },
												{ "msid", "7654-5467-5647435-345" } }),
								SourceUtil.createSourceWithSsrc(2357561L, new String[][] { { "cname", "kl65j7kl56jl" },
										{ "msid", "5747-4355-56723-34557" } }) });
		SourceGroup videoGroup2 = SourceUtil
				.createSourceGroup(SourceGroupPacketExtension.SEMANTICS_SIMULCAST,
						new SourcePacketExtension[] {
								SourceUtil.createSourceWithSsrc(
										8768678L,
										new String[][] { { "cname", "fdg897g98" },
												{ "msid", "675768-678-678-678-65787" } }),
								SourceUtil.createSourceWithSsrc(3543556L,
										new String[][] { { "cname", "5bv3n5b" },
												{ "msid", "6758-6786456-567856-86758" } }),
								SourceUtil.createSourceWithSsrc(5675634L, new String[][] { { "cname", "67klm8lk768l" },
		...
		/*
		 * toRemove.getSourceGroupsForMedia("audio").add( SourceUtil.createSourceGroup(
		 * SourceGroupPacketExtension.SEMANTICS_SIMULCAST, new SourcePacketExtension[]{
		 * SourceUtil.createSourceWithSsrc(324234L, new String[][]{ {"cname", "dfggdf"},
	...
	private void compareGroupMaps(MediaSourceGroupMap g1, MediaSourceGroupMap g2) {
		...
		for (String mediaType : mediaTypes1) {
			assertEquals(g1.getSourceGroupsForMedia(mediaType), g2.getSourceGroupsForMedia(mediaType));
		}
	}
